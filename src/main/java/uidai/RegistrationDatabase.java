...
public class RegistrationDatabase extends RandomAadharNumber 
{
	public String validate(String mobile, String pass) throws SQLException {
	    ...
	    String create_table = "create table if not exists authentication(mobileNo VARCHAR(10) unique, Password VARCHAR(40), aadharNumber VARCHAR(12) unique)";
	    stmt.executeUpdate(create_table);
	    String create_table1 = "create table if not exists address (aadharNo VARCHAR(12) unique, hNo VARCHAR(40), street VARCHAR(40), area VARCHAR(40), landmark VARCHAR(40), town VARCHAR(40), subDistrict VARCHAR(40), district VARCHAR(40), state VARCHAR(40), pin INT(6), finalAddress VARCHAR(100))";
